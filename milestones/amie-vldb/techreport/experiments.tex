...
%\comment{Chris}{In order to keep the search tractable and the experimental study manageable we ran AMIE with $maxLen=3$} % Fabian: This was said already.
...
\end{enumerate}
%We also investigated the individual effects of the enhancements by enabling the output enhancements and one refinement enhancement at a time (columns +MRL, +QRW, +PR).
...
\begin{table}[!htbp]
\begin{tabular}{p{2.3cm}|p{3cm}| p{1cm}}
...
% AMIE+ mined 62 typed rules.
%on a dataset consisting of YAGO2 and 2.29M
