...
\paragraph{Caching Projection Queries}
...
The calculation of the  rules' confidence takes a significant part of the time of the overall rule-mining process. 
\comment{Chris}{can we add a number here?}
...
AMIE needs more than 500ms to calculate the confidence of this intuitively bad rule.
