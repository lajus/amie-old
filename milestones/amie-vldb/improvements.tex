...
We pre-compute these quantities, so that they be accessed in constant time\comment{Luis}{Was it intended to be subjunctive: \url{http://english.stackexchange.com/questions/58634/so-that-it-be-vs-so-that-it-is?}}. As a result, AMIE+ prunes the example-rule above in less than 1ms.  
