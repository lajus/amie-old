...
\end{array}
\]
That is, we need to find out how many actors $y$ correspond to each director $x$ in the body of the rule ($\#y_{per\;x}$), and then
count of how many of those are married.
%We need to find out how many actors correspond to each director ($\#y_{per\;x}$) in the body of the rule.
Therefore we walk through the path $x \rightarrow z \rightarrow y$, connecting a director to his potential actors. If $fun(r)$ and $ifun(r)$
