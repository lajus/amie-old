...
respectively of the individual paths \comment{Luis}{This part is not clear. You are suggesting the minimum of which expression exactly?}. We could, therefore, use these upper bounds to approximate them.
