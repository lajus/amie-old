...
Most rule mining applications have no use for rules with low confidence. For example, predictions based on rules with 1\% confidence are not useful in practice.
