...
For mining the rules, Sherlock uses two heuristics: statistical significance and statistical relevance. \comment{Luis}{To protect us from the reviewers, we should argue why Sherlock is not applicable to our setting.}
