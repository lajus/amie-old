...
We have shown that our approach outperformed other rule mining systems %that can also work without explicit counterexamples
...
\item A comprehensive investigation and description of the AMIE approach, including a description of our in-memory database and an evaluation of AMIE's fundamental assumption, the PCA. %the partial completeness assumption (PCA), its central assumption.
