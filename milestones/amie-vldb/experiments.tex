...
\comment{Luis}{We stick to past tense then}
...
\multirow{3}{*}{KB} 	& \multirow{3}{*}{AMIE}  	& \multicolumn{5}{c}{AMIE+} 	\\ \cline{3-8}
  ...
  DBpedia 3.8  		& $>$ 1 day  			&$>$ 1 day			&\textcolor{red}{14h 10min*}	& 8h 35min 			&7h 33min*	&10h 11min*  			& 7h 6min 	   	\\ \hline
...
Notice also that AMIE+(only Output) is only marginally faster than AMIE. This is because the confidence approximation heuristic requires  
...
Perfect rules are not so frequent in KBs. This reduces the applicability of the enhacement by itself.
...
KB			& Rules 		& Rules		&Pruned	& Prun. prec. 	   \\ \hline
  ...
  Wikidata  		& \textcolor{red}{746*}	& 1512		&943 	&\textcolor{red}{96.94\%}      	    \\  \hline
\end{tabular}
