...
This provides a hint of how fast the search space increases for longer rules. 
The result is that mining on YAGO2 with $maxLen=4$ is 7.9x slower than on YAGO with $maxLen=3$ (see Table~\ref{amievsplus}).
