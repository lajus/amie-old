...
which makes them less interesting for rule mining. Except for YAGO, 
we removed the \emph{rdf:type} relationship because it inflates the size of the KBs. 
...
Wikidata\footnote{Dump from December 2014 available at \url{http://tools.wmflabs.org/wikidata-exports/rdf/exports/20140420/}} & 11.30M & 4.00M & 431
...
the lossless optimizations introduced in Section~\ref{subsec:lossless}. In its parameter-less variant, which we will use in the following, 
