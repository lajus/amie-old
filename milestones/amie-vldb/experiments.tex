...
\hline
			& AMIE			 	& \multicolumn{2}{c|}{AMIE+} 	\\ \cline{2-4}
KB			& Rules 			& Rules		& Prun. prec. 	   \\ \hline
  YAGO2  		& 135				& 135 		& 100.00\%      	    \\ 
...
\includegraphics[width=0.5\textwidth]{figures/std_vs_pca_new}
\caption{Std. confidence vs. PCA confidence}
\label{finalshow}
\end{figure}

\paragraph{Using Type Information}
The naive inference approach presented in~\cite{amie} was designed as a proof of concept 
