...
\paragraph{Hardware}
All experiments are run on a server with 48GB of RAM and 8 CPUs (Intel Xeon at 2.4GHz). All rules and all experimental results are available at \comment{Chris}{did this change?} \url{http://www.mpi-inf.mpg.de/departments/ontologies/projects/amie/}.
...
the lossless optimizations introduced in Section~\ref{prunebound}. In its parameter-less variant, which we will use in the following, 
