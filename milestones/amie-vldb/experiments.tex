...
As we can see, the pruning by approximation does not entail a serious decrease in the quality of the output:  AMIE+ does not miss more than 4\% of the rules with confidence above 10\%.  At the same time, the pruning yields a speed-up by a factor of up to 3, as Table~\ref{outputComparison} shows.

\paragraph{Example rules}
Table~\ref{rules} shows some examples of highly confident rules with two and three atoms mined by AMIE on the testing datasets.
...
some examples.\comment{Luis}{TODO: Explain why rules with 4 atoms are bad}
