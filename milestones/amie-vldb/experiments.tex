...
\multirow{3}{*}{KB} 	& \multirow{3}{*}{AMIE}  	& \multicolumn{5}{c}{AMIE+} 	\\ \cline{3-8}
  ...
  YAGO2 (4)  		& 28.47min  			&9.49min			& 26.48min 			& 8.65min  			&15.69min 	&24.20min  			& 8.35min 	   	\\ \hline
...
for YAGO2, most of the time is spent in refining rules (Table~\ref{timeProportion}). Therefore, the improvements in this phase result in a significant gain.
