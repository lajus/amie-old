...
public class TestEquivalenceChecker2 extends TestCase {
	...
	public void test4(){
		assertTrue(EquivalenceChecker2.equal(cases.get(4).first, cases.get(4).second));
	}
	
	public void test5(){
		assertTrue(EquivalenceChecker2.equal(cases.get(5).first, cases.get(5).second));
	}
	...
	public void test12(){
		assertTrue(!EquivalenceChecker2.equal(cases.get(12).first, cases.get(12).second));
	}
	...
	public void test15(){
		assertTrue(EquivalenceChecker2.equal(cases.get(15).first, cases.get(15).second));
	}
	
	public void test16(){
		assertTrue(EquivalenceChecker2.equal(cases.get(16).first, cases.get(16).second));
	}
	...
	public void test18(){
		assertTrue(EquivalenceChecker2.equal(cases.get(18).first, cases.get(18).second));
	}
	
	public void test19(){
		assertTrue(EquivalenceChecker2.equal(cases.get(19).first, cases.get(19).second));
	}
	...
	public void test22(){
		assertTrue(EquivalenceChecker2.equal(cases.get(22).first, cases.get(22).second));
	}
	
	public void test23(){
		assertTrue(EquivalenceChecker2.equal(cases.get(23).first, cases.get(23).second));
	}
