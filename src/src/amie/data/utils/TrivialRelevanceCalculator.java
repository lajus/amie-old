...
public class TrivialRelevanceCalculator {
	...
	public static void main(String[] args) throws IOException {
		...
		Set<ByteString> allEntities = kb.selectDistinct(ByteString.of("?s"), KB.triples(KB.triple("?s", "?p", "?o")));
		allEntities.addAll(kb.selectDistinct(ByteString.of("?o"), KB.triples(KB.triple("?s", "?p", "?o"))));
